import { PolygonEventHistoryRepository } from '@app/shared_modules/event_history/repositories/event_history.repository';
import {
  EventHistory,
  WebhookType,
} from '@app/shared_modules/event_history/schemas/event_history.schema';
import { PolygonMonitorAddressRepository } from '@app/shared_modules/monitor/repositories/monitor.address.repository';
...
export class PolygonService {
  ...
  @Inject()
  private readonly monitorAddressRepository: PolygonMonitorAddressRepository;
