import { BscEventHistoryRepository } from '@app/shared_modules/event_history/repositories/event_history.repository';
import {
  EventHistory,
  WebhookType,
} from '@app/shared_modules/event_history/schemas/event_history.schema';
import { BscMonitorAddressRepository } from '@app/shared_modules/monitor/repositories/monitor.address.repository';
...
export class BscService {
  ...
  @Inject()
  private readonly monitorAddressRepository: BscMonitorAddressRepository;
  ...
  @Inject()
  private readonly eventHistoryRepository: BscEventHistoryRepository;
