import { MantleEventHistoryRepository } from '@app/shared_modules/event_history/repositories/event_history.repository';
import {
  EventHistory,
  WebhookType,
} from '@app/shared_modules/event_history/schemas/event_history.schema';
import { MantleMonitorAddressRepository } from '@app/shared_modules/monitor/repositories/monitor.address.repository';
...
export class MantleService {
  ...
  @Inject()
  private readonly monitorAddressRepository: MantleMonitorAddressRepository;
  ...
  @Inject()
  private readonly eventHistoryRepository: MantleEventHistoryRepository;
